...
# --- 2. KẾT NỐI GOOGLE SHEETS (DÙNG CHÌA KHÓA TRỰC TIẾP - ĐÃ FIX LỖI) ---
@st.cache_resource
def connect_google_sheet():
    scope = ["https://spreadsheets.google.com/feeds", "https://www.googleapis.com/auth/drive"]
    
    # --- CHÌA KHÓA ĐÃ ĐƯỢC ĐỊNH DẠNG LẠI THỦ CÔNG ---
    # Sử dụng dấu nháy 3 (""") để giữ nguyên định dạng xuống dòng chuẩn của Google
...
-----END PRIVATE KEY-----"""
    ...
    creds_dict = {
        ...
        "private_key": pk, # Dùng biến pk ở trên
